...
const HIGH_CONFIDENCE_FIXES: Array<{
  ...
  {
    countryNameContains: ['Australia'],
    domainContains: ['smh.com.au'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.smh.com.au/rss/feed.xml'],
    note: 'SMH uses /rss/feed.xml in current valid pattern.',
  },
  {
    countryNameContains: ['Australia'],
    domainContains: ['theage.com.au'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.theage.com.au/rss/feed.xml'],
    note: 'The Age moved from /rss/ root to /rss/feed.xml.',
  },
  {
    countryNameContains: ['Australia'],
    domainContains: ['canberratimes.com.au'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.canberratimes.com.au/rss.xml'],
    note: 'Use RSS file feed instead of directory path.',
  },
  {
    countryNameContains: ['Australia'],
    domainContains: ['perthnow.com.au'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.perthnow.com.au/news/feed'],
    note: 'PerthNow publishes feed from /news/feed.',
  },
  {
    countryNameContains: ['Australia'],
    domainContains: ['abc.net.au'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.abc.net.au/news/feed/104217382/rss.xml', 'https://www.abc.net.au/news/feed/10719986/rss.xml'],
    note: 'ABC section feed endpoint by ID appears to be active.',
  },
  {
    countryNameContains: ['Australia'],
    domainContains: ['sbs.com.au'],
    reason: 'HTTP_404',
    action: 'TRY_REPLACE',
    candidates: ['https://www.sbs.com.au/news/feed', 'https://www.sbs.com.au/news/topic/latest/feed'],
    note: 'Trim trailing slash or use topic feed endpoint.',
  },
  {
    countryNameContains: ['Australia'],
    domainContains: ['theguardian.com'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.theguardian.com/australia-news/rss'],
    note: 'Use section-level Guardian RSS endpoint.',
  },
  {
    countryNameContains: ['Austria'],
    domainContains: ['derstandard.at'],
    reason: 'HTML_RETURNED',
    action: 'REPLACE',
    candidates: ['https://www.derstandard.at/rss'],
    note: 'Der Standard canonical endpoint moved to /rss.',
  },
  {
    countryNameContains: ['Austria'],
    domainContains: ['orf.at'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://rss.orf.at/news.xml'],
    note: 'Use ORF top-level news feed.',
  },
  {
    countryNameContains: ['Austria'],
    domainContains: ['kurier.at'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://kurier.at/xml/rssd'],
    note: 'Kurier now exposes directory at /xml/rssd.',
  },
  {
    countryNameContains: ['Austria'],
    domainContains: ['tt.com'],
    reason: 'HTTP_404',
    action: 'TRY_REPLACE',
    candidates: ['https://www.tt.com/rss/news.xml'],
    note: 'TT section feed endpoint.',
  },
  {
    countryNameContains: ['Belgium'],
    domainContains: ['vrt.be'],
    reason: 'HTTP_404',
    action: 'TRY_REPLACE',
    candidates: ['https://www.vrt.be/vrtnws/nl.rss.articles.xml'],
    note: 'Use article-level VRT feed endpoint.',
  },
  {
    countryNameContains: ['Belgium'],
    domainContains: ['lalibre.be'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.lalibre.be/arc/outboundfeeds/rss/section/belgique/?outputType=xml'],
    note: 'La Libre feed appears in Arc outboundfeeds.',
  },
  {
    countryNameContains: ['Belgium'],
    domainContains: ['lesoir.be'],
    reason: 'HTTP_403',
    action: 'TRY_REPLACE',
    candidates: ['https://www.lesoir.be/rss2/9/cible_principale'],
    note: 'Alternative RSS endpoint for Le Soir.',
  },
  {
    countryNameContains: ['Belgium'],
    domainContains: ['rtbf.be'],
    reason: 'HTTP_404',
    action: 'TRY_REPLACE',
    candidates: ['https://rss.rtbf.be/article/rss/highlight_rtbf_info.xml?source=internal'],
    note: 'RTBF highlight feed endpoint (alternate host).',
  },
  {
    countryNameContains: ['Belgium'],
    domainContains: ['levif.be'],
    reason: 'HTTP_405',
    action: 'TRY_REPLACE',
    candidates: ['https://www.levif.be/feed/'],
    note: 'Use Le Vif feed endpoint.',
  },
  {
    countryNameContains: ['Netherlands'],
    domainContains: ['nos.nl'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://feeds.nos.nl/nosnieuwsalgemeen', 'https://feeds.nos.nl/nosnieuwseconomie', 'https://feeds.nos.nl/nosnieuwstech'],
    note: 'NOS is currently served from feeds.nos.nl.',
  },
  {
    countryNameContains: ['Netherlands'],
    domainContains: ['nieuwsuur.nl'],
    reason: 'HTML_RETURNED',
    action: 'TRY_REPLACE',
    candidates: ['https://feeds.nos.nl/nieuwsuuralgemeen'],
    note: 'Nieuwsuur appears to map to NOS feeds domain.',
  },
  {
    countryNameContains: ['Brazil'],
    domainContains: ['noticias.r7.com'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://noticias.r7.com/feed.xml'],
    note: 'R7 uses /feed.xml in current tests.',
  },
  {
    countryNameContains: ['Brazil'],
    domainContains: ['canaltech.com.br'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://canaltech.com.br/rss/'],
    note: 'Canaltech section feed URL is /rss/.',
  },
  {
    countryNameContains: ['Spain'],
    domainContains: ['feeds.elpais.com'],
    action: 'TRY_REPLACE',
    reason: 'HTTP_404',
    candidates: ['https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/portada'],
    note: 'Fallback from section endpoint to portada RSS.',
  },
  {
    countryNameContains: ['Spain'],
    domainContains: ['elconfidencial.com'],
    reason: 'HTML_RETURNED',
    action: 'REPLACE',
    candidates: ['https://rss.elconfidencial.com/espana/'],
    note: 'El Confidencial RSS host moved.',
  },
  {
    countryNameContains: ['Spain'],
    domainContains: ['eldiario.es'],
    reason: 'HTTP_404',
    action: 'REPLACE',
    candidates: ['https://www.eldiario.es/rss/'],
    note: 'Use base RSS path.',
  },
  {
    countryNameContains: ['Spain'],
    domainContains: ['elperiodico.com'],
    reason: 'HTML_RETURNED',
    action: 'REPLACE',
    candidates: ['https://www.elperiodico.com/es/rss/rss_portada.xml'],
    note: 'Use El Periodico portada RSS.',
  },
];
