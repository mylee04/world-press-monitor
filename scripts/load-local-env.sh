...
load_local_env() {
  ...
  mirror_prefixed_env "WPR_PUBLIC_DATA_DIR" "WPM_PUBLIC_DATA_DIR"
  mirror_prefixed_env "WPR_WEB_DIST_DIR" "WPM_WEB_DIST_DIR"
  ...
  mirror_prefixed_env "WPR_POST_INGEST_EXPORT" "WPM_POST_INGEST_EXPORT"
  mirror_prefixed_env "WPR_EXPOSE_PUBLIC_EXPORTS" "WPM_EXPOSE_PUBLIC_EXPORTS"
