...
const FOREIGN_OPERATED_RULES: ForeignOperatedRule[] = [
  ...
  },
  {
    ...
    exact: ['Al Arabiya (Business - Arabic)', 'Al Arabiya (EN - Business)', 'Al Arabiya (EN - Middle East)'],
    corporateCountry: 'United Arab Emirates',
    corporateCity: 'Dubai',
    corporateRegion: 'Dubai',
    corporateLat: 25.2048,
    corporateLon: 55.2708,
    label: 'Al Arabiya HQ',
  },
  {
    marketCountry: 'Saudi Arabia',
    exact: ['Asharq Business (Bloomberg Arabic)'],
    corporateCountry: 'United Arab Emirates',
    corporateCity: 'Dubai',
    corporateRegion: 'Dubai',
    corporateLat: 25.2048,
    corporateLon: 55.2708,
    label: 'Bloomberg Asharq HQ',
  },
  {
    marketCountry: 'Saudi Arabia',
    exact: ['CNBC Arabia (Middle East Economy)'],
    corporateCountry: 'United Arab Emirates',
    corporateCity: 'Dubai',
    corporateRegion: 'Dubai',
    corporateLat: 25.2048,
    corporateLon: 55.2708,
    label: 'CNBC Arabia HQ',
  },
  {
    marketCountry: 'Saudi Arabia',
    exact: ['Sky News Arabia (Arabic Business)'],
    corporateCountry: 'United Arab Emirates',
    corporateCity: 'Abu Dhabi',
    corporateRegion: 'Abu Dhabi',
    corporateLat: 24.4539,
    corporateLon: 54.3773,
    label: 'Sky News Arabia HQ',
  },
  {
    marketCountry: 'Saudi Arabia',
    exact: ['Zawya (Middle East Business 1위 - EN)', 'Zawya Arabic (Middle East Business)'],
    corporateCountry: 'United Arab Emirates',
    corporateCity: 'Dubai',
    corporateRegion: 'Dubai',
    corporateLat: 25.2048,
  ...
  {
    marketCountry: 'Saudi Arabia',
    exact: ['Arabian Business'],
    corporateCountry: 'United Arab Emirates',
    corporateCity: 'Dubai',
    corporateRegion: 'Dubai',
    corporateLat: 25.2048,
    corporateLon: 55.2708,
    label: 'Arabian Business HQ',
  },
  {
    marketCountry: 'Saudi Arabia',
    exact: ['Economy Middle East'],
    corporateCountry: 'United Arab Emirates',
    corporateCity: 'Dubai',
    corporateRegion: 'Dubai',
    corporateLat: 25.2048,
    corporateLon: 55.2708,
    label: 'Economy Middle East HQ',
  },
  {
    marketCountry: 'Nigeria',
    exact: ['Nigerian Eye'],
    corporateCountry: 'Canada',
    corporateCity: 'Toronto',
    corporateRegion: 'Ontario',
    corporateLat: 43.6532,
    corporateLon: -79.3832,
    label: 'Nigerian Eye HQ',
  },
  {
    marketCountry: 'Nigeria',
    exact: ['Sahara Reporters'],
    corporateCountry: 'United States',
    corporateCity: 'New York',
    corporateRegion: 'New York',
    corporateLat: 40.7128,
    corporateLon: -74.006,
    label: 'Sahara Reporters HQ',
  },
];
