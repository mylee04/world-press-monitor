...
const SECTION_TOPIC_RULES: Partial<Record<NewsSection, readonly TopicRule[]>> = {
  ...
  health: [
    { topic: 'general health', patterns: [rx('health|salud|saude|saúde|sant[eé]|salute|sanidad|wellness|건강|의료|здоровье|sveikata|sağlık|health news|bienestar')] },
    ...
    { topic: 'healthcare', patterns: [rx('hospital|clinic|healthcare|medical care|nursing|medicare|insurance plan|surgery|m[eé]dic|doctor|doctors|physician|patient|patients|clinica|cl[ií]nica|medicina|medis')] },
  ...
  entertainment: [
    { topic: 'general entertainment', patterns: [rx('entertainment|showbiz|showbizz|espect[aá]culos|farándula|hiburan|娛樂|娱乐|연예|연예뉴스|芸能|diversión|famosos|selebriti|entertainment news')] },
    ...
    { topic: 'film / tv', patterns: [rx('film\\b|movie|cinema|television|tv series|streaming|netflix|box office|drama|series|serial|telenovela|sinetron')] },
    { topic: 'music', patterns: [rx('music|album|single\\b|concert|tour dates|festival|billboard charts|lagu|penyanyi|konser')] },
    { topic: 'celebrities', patterns: [rx('celebrit|actor|actress|star couple|influencer|royal family|seleb|artist\\b|public figure')] },
