...
import { readNewsDashboardSummaryWithDeps } from '@/lib/news-dashboard-store';
import {
  readFailingEndpointBackoffWithDeps,
  readNewsArticlesEarliestCreatedAtWithDeps,
  readNewsArticlesRecentCountsWithDeps,
  readSitemapPolicyStatesWithDeps,
  upsertSitemapPolicyStatesWithDeps,
  type EndpointBackoffRow,
  type NewsArticlesRecentCountRow,
...
export async function readNewsArticlesForApi(options: {
  ...
  return readNewsArticlesForApiWithDeps(
    {
      getPool,
      ensureSchema,
      poolDisabledReason,
      ...
      validNewsSectionList: VALID_NEWS_SECTION_LIST,
      customerVisibleTitleQualitySql: CUSTOMER_VISIBLE_TITLE_QUALITY_SQL,
      buildCustomerVisibleTitleQualitySql,
      normalizeStoredSectionValue,
    },
    options
  );
}
...
export async function readNewsDashboardSummary(options?: {
  ...
  return readNewsDashboardSummaryWithDeps(
    {
      getPool,
      ensureSchema,
      poolDisabledReason,
      newsApiMaxFutureMinutes,
      dashboardTopicDisplayLimit,
      dashboardSourceCategoryDisplayLimit,
      dashboardSummaryCacheMs,
...
export async function readNewsApiFilters(): Promise<NewsApiFiltersResult> {
  return readNewsApiFiltersWithDeps({
    getPool,
    ensureSchema,
    poolDisabledReason,
    apiSnippetMaxChars,
...
export async function readSitemapPolicyStates(rows: ReadSitemapPolicyInput[]): Promise<Map<string, SitemapPolicyState>> {
  return readSitemapPolicyStatesWithDeps({
    getPool,
    ensureSchema,
    poolDisabledReason,
...
export async function readFailingEndpointBackoff(options: {
  ...
  return readFailingEndpointBackoffWithDeps({
    getPool,
    ensureSchema,
    poolDisabledReason,
    executeIngestionQuery,
...
export async function readNewsArticlesEarliestCreatedAt(): Promise<{
  ...
  return readNewsArticlesEarliestCreatedAtWithDeps({
    getPool,
    ensureSchema,
    poolDisabledReason,
    executeIngestionQuery,
...
export async function readNewsArticlesRecentCounts(options: {
  ...
  return readNewsArticlesRecentCountsWithDeps({
    getPool,
    ensureSchema,
    poolDisabledReason,
    executeIngestionQuery,
